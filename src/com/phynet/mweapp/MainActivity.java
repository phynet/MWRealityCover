...
public class MainActivity extends MetaioSDKViewActivity {
	...
	protected void loadContent() {
		...
		try
		{
		    ...
		    String imagePath = AssetsManager.getAssetPath("Assets1/TwoKeys_target.png");
	...
	protected void onGeometryTouched(IGeometry geometry) {
		// We need to implement this method in order to add events when user touch the image
